...
<table>
        <tr>
            <th>Final Score</th>
            <th>First Quarter Score</th>
            <th>Second Quarter Score</th>
            <th>Third Quarter Score</th>
            <th>Fourth Quarter Score</th>
            <th>Year</th>
            <th>Super Bowl Number</th>
        </tr>
   <?php
            //Loop to print out all of the data from the database
            for ($i = 0; $i < $rows; $i++) {
                $fullRow = $result -> fetch_array(MYSQLI_ASSOC);
                echo '<tr><td>' . $fullRow['Final_Score'] . '</td>';
                echo '<td>' . $fullRow['FirstQ_Score'] . '</td>';
                echo '<td>' . $fullRow['SecondQ_Score'] . '</td>';
                echo '<td>' . $fullRow['ThirdQ_Score'] . '</td>';
                echo '<td>' . $fullRow['FourthQ_Score'] . '</td>';
                echo '<td>' . $fullRow['Year'] . '</td>';
                echo '<td>' . $fullRow['SuperBowl_Num'] . '</td>';               
            }
    ?>
</table>
