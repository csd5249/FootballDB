...
<body class="main">
    <?php
        ...
        $query = "SELECT Player_FName, Player_LName, Player_DOB, Player_Weight, Player_Height, Player_College FROM player WHERE Player_ID NOT IN (SELECT Player_fk FROM retiredplayer)";
...
<h1 class="header">Current Players</h1>
